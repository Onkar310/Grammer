...
class x86asmListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by x86asmParser#program.
    def enterProgram(self, ctx:x86asmParser.ProgramContext):
        pass

    # Exit a parse tree produced by x86asmParser#program.
    def exitProgram(self, ctx:x86asmParser.ProgramContext):
        pass
